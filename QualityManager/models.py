...
class UserInfo(AbstractUser):
    """用户表"""
    nick_name=models.CharField(max_length=10,verbose_name="岗位名称",default="新用户")
    def __str__(self):
...
class BugDetail(models.Model):
    """bug详情表"""
    ver=models.ForeignKey(to="Version",on_delete=models.CASCADE,null=True,related_name="ver")
    pro=models.ForeignKey(to="Project",on_delete=models.CASCADE,null=True,related_name="pro")
    ...
    order_to=models.ForeignKey(to="UserInfo",on_delete=models.CASCADE,null=True)
    ...
    creat_user=models.ForeignKey(to="UserInfo",on_delete=models.CASCADE,null=True,related_name="creat_user")
    def __str__(self):
        return self.title
    class Meta:
        db_table="BugDetail"